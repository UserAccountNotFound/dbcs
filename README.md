...
![GitHub repo size](https://img.shields.io/github/repo-size/UserAccountNotFound/vCardProject)
...
4. Устанавливаем зависимости сервиса:
```bash
...
6.1. Запуск DEV-окружения:
```bash
flask run --host=0.0.0.0
```

6.2. Запуск PROD-окружения:
